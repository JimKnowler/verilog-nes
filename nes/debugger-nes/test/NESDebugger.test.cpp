...
#include "nes/NESDebuggerTestBench.h"
using namespace nesdebuggertestbench;

namespace {
    class NESDebugger : public ::testing::Test {
    public:
        void SetUp() override {
        ...
        NESDebuggerTestBench testBench;
    };
...
TEST_F(NESDebugger, ShouldConstruct) {

}

TEST_F(NESDebugger, ShouldReset) {
    testBench.reset();
...
TEST_F(NESDebugger, ShouldImplementCmdNOP) {
    auto& core = testBench.core();
...
TEST_F(NESDebugger, ShouldImplementCmdEcho) {
...
TEST_F(NESDebugger, ShouldImplementMemoryWrite) {
...
TEST_F(NESDebugger, ShouldImplementMemoryRead) {
...
TEST_F(NESDebugger, ShouldSupportGapsBetweenRxBytes) {
    const int kTestValue = 42;
...
TEST_F(NESDebugger, ShouldImplementValueWrite) {
...
TEST_F(NESDebugger, ShouldImplementValueRead) {
