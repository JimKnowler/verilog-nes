...
// should ignore i_irq_n = 0, while I flag is set - then use it when the flag is cleared
// should not ingore i_irq_n = 0, when returning from interrupt handler
// should handle NMI - i_nmi_n = 0 for 2 cycles after falling from 1 (should default simulation to 1)
// should ignore i_nmi_n = 0 until it goes high again
// should not ignore i_nmi_n = 0, when I flag is set
